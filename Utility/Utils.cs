...
namespace CJF.Utility
{
	...
	public static class ConvUtils
	{
		...
		#region 已移至 CJF.Utility.Extensions 擴充函示類別
		...
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToHexString() 擴充函示", true)]
		...
		/// <param name="hex">16進位字串</param>
		/// <returns></returns>
		[Obsolete("請使用 CJF.Utility.Extensions.StringExtension.ToByteArray() 擴充函示", true)]
		...
		[Obsolete("請使用 CJF.Utility.Extensions.Int16Extension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.UInt16Extension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.Int32Extension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.UInt32Extension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.Int64Extension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.UInt64Extension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extension.DoubleExtension.GetBytes() 擴充函示", true)]
		...
		/// <param name="getBigEndian">是否傳回BigEndian的陣列</param>
		/// <returns>位元組陣列</returns>
		[Obsolete("請使用 CJF.Utility.Extension.SingleExtension.GetBytes() 擴充函示", true)]
		...
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToInt64() 擴充函示", true)]
		public static long ToInt64(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToInt64(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToInt64(start, getBigEndian);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToUInt64() 擴充函示", true)]
		public static ulong ToUInt64(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToUInt64(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToUInt64(start, getBigEndian);
			//byte[] buffer = new byte[8];
			//Array.Copy(bytes, start, buffer, 0, 8);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToInt32() 擴充函示", true)]
		public static int ToInt32(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToInt32(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToInt32(start, getBigEndian);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToUInt32() 擴充函示", true)]
		public static uint ToUInt32(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToUInt32(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToUInt32(start, getBigEndian);
			//byte[] buffer = new byte[4];
			//Array.Copy(bytes, start, buffer, 0, 4);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToInt16() 擴充函示", true)]
		public static short ToInt16(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToInt16(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToInt16(start, getBigEndian);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToUInt16() 擴充函示", true)]
		public static ushort ToUInt16(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToUInt16(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToUInt16(start, getBigEndian);
			//byte[] buffer = new byte[2];
			//Array.Copy(bytes, start, buffer, 0, 2);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToDouble() 擴充函示", true)]
		public static double ToDouble(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToDouble(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1d)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToDouble(start, getBigEndian);
			//byte[] buffer = new byte[8];
			//Array.Copy(bytes, start, buffer, 0, 8);
		...
		/// <param name="getBigEndian">傳入的陣列是否為BigEndian</param>
		/// <returns>數值</returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtension.ToSingle() 擴充函示", true)]
		public static float ToSingle(byte[] bytes, bool getBigEndian)
		{
			return bytes.ToSingle(getBigEndian);
			//bool sysIsLittleEndian = (BitConverter.GetBytes(1f)[0] == 0);
			//if (sysIsLittleEndian != getBigEndian)
			//    Array.Reverse(bytes);
		...
		{
			return bytes.ToSingle(start, getBigEndian);
			//byte[] buffer = new byte[4];
			//Array.Copy(bytes, start, buffer, 0, 4);
		...
		{
			return source.PadRightFixLength(totalByteLength);
		...
		{
			return source.PadLeftFixLength(totalByteLength);
			//int len = Encoding.Default.GetByteCount(source);
			//if (len == totalByteLength) return source;
			//if (len > totalByteLength)
			//{
		...
		/// <param name="totalByteLength">總長度，位元為單位</param>
		/// <returns></returns>
		[Obsolete("請使用 CJF.Utility.Extensions.StringExtensions.PadCenter()", true)]
		public static string PadCenter(string source, int totalByteLength)
		{
			return source.PadCenter(totalByteLength);
			//int len = Encoding.Default.GetByteCount(source);
			//if (len >= totalByteLength) return source;
		...
		/// <returns></returns>
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtensions.SequenceEqual()", true)]
		...
		[Obsolete("請使用 CJF.Utility.Extensions.ArrayExtensions.IndexOfBytes()", true)]
		public static int IndexOfBytes(byte[] source, byte[] pattern, int startIndex = 0)
		{
			return source.IndexOfBytes(pattern, startIndex);
		...
		/// <summary>使用 GZipStream 壓縮位元組資料</summary>
