...
namespace CJF.Utility.WinKits
{
    ...
    public class AnsiLabel : Control
    {
        ...
        /// <summary>發生於 CJF.Utility.WinKits.AnsiLabel.AutoSize 屬性值變更時。</summary>
        [Browsable(true), EditorBrowsable(EditorBrowsableState.Always)]
        new public event EventHandler AutoSizeChanged;
        /// <summary>發生於 CJF.Utility.WinKits.AnsiLabel.BorderStyle 屬性值變更時。</summary>
        public event EventHandler BorderStyleChanged;

        #region Consts & Readonly Variables
        ...
        [Browsable(true), EditorBrowsable(EditorBrowsableState.Always), RefreshProperties(RefreshProperties.All)]
        [Localizable(true), DefaultValue(false), DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        ...
        [DefaultValue(BorderStyle.None), Browsable(true), RefreshProperties(RefreshProperties.All)]
        ...
        [Category("Layout"), Localizable(true), Description("文字與邊框間的指定間距 (以像素為單位)。")]
        ...
        /// <summary>取得表示控制項文字工作區的矩形。即完整大小扣除邊界範圍。</summary>
        ...
        new public Rectangle ClientRectangle
        {
            get
            {
                ...
                if (AutoSize)
                {
                    ...
                    SizeF tf = this.CreateGraphics().MeasureString(CsiBuilder.GetPureText(text), this.Font);
                    rect = new Rectangle(_Padding.LeftTop(), tf.ToSize());
                }
                else
                {
                    rect = new Rectangle(_Padding.LeftTop(), this.Size);
        ...
        #region New Public Property : Size Size(R/W)
        /// <summary>取得或設定控制項的高度和寬度。</summary>
        [Localizable(true), CategoryAttribute("Layout"), DescriptionAttribute("控制項的高度和寬度。")]
        new public Size Size { get => base.Size; set { if (!AutoSize) base.Size = value; } }
        #endregion
        ...
        [EditorBrowsable(EditorBrowsableState.Advanced)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        new public string ProductName => this.GetType().ToString();
        #endregion
        ...
        protected override Size DefaultSize => new Size(120, 30);
        #endregion
        ...
        #region Protected Override Property : Padding DefaultMargin(R)
        ...
        {
            string text = this.Text.Replace("\\x1b", "\\x1B").Replace("\\x1B", "\x1B");
            Point pt = _Padding.LeftTop();
            if (this.BorderStyle != BorderStyle.None)
                pt.Offset(1, 1);
            pt.Offset(2, 0);
            _LastLocation = DrawAnsiCsiSgrText(e.Graphics, text, pt);
        ...
        #region Protected Override Method : void OnAutoSizeChanged(EventArgs e)
        /// <summary>當控制項的 AutoSize 屬性值變更時，引發 CJF.Utility.WinKits.AnsiLabel.AutoSizeChanged 事件。</summary>
        /// <param name="e">包含事件資料的 System.Windows.Forms.EventArgs。</param>
        protected override void OnAutoSizeChanged(EventArgs e)
        {
            ...
            if (this.AutoSizeChanged != null)
                this.AutoSizeChanged.BeginInvoke(this, e, null, null);

        }
        #endregion

        #region Protected Override Method : void OnFontChanged(EventArgs e)
        /// <summary>當控制項的 Font 屬性值變更時，引發 CJF.Utility.WinKits.AnsiLabel.FontChanged 事件。</summary>
        /// <param name="e">包含事件資料的 System.Windows.Forms.EventArgs。</param>
        ...
        #region Protected Override Method : void OnCreateControl()
        /// <summary>當已建立控制項時，會呼叫此函式。</summary>
        ...
        #region Public Event : BorderStyleChanged
        /// <summary>當控制項的 BorderStyle 屬性值變更時，引發 CJF.Utility.WinKits.AnsiLabel.BorderStyleChanged 事件。</summary>
        /// <param name="e">包含事件資料的 System.Windows.Forms.EventArgs。</param>
        protected virtual void OnBorderStyleChanged(EventArgs e)
        {
            this.Refresh();
            if (this.BorderStyleChanged != null)
                this.BorderStyleChanged.BeginInvoke(this, e, null, null);
        }
        #endregion
        ...
        public override void Refresh()
        {
            ...
            {
                SizeF tf = Size.Empty;
                _LineHeight = grp.MeasureString("\r", this.Font, Point.Empty, _DefFormat).Height;
                string text = this.Text.Replace("\\x1b", "\\x1B").Replace("\\x1B", "\x1B");
                if (this.AutoSize)
                {
                    tf = grp.MeasureString(CsiBuilder.GetPureText(text), this.Font);
                    this.ClientSize = new Size((int)tf.Width + _Padding.Horizontal + 2, (int)tf.Height + _Padding.Vertical);
                }
            }
            base.Refresh();
        }
        ...
        private void InitializeComponent()
        {
            ...
            base.AutoSize = false;
            _OriginalSize = this.DefaultSize;
            this.ClientSize = this.DefaultSize;
